# Generated by Django 4.2.2 on 2023-11-26 01:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('superusuario', 'Superusuario'), ('administrador', 'Administrador'), ('tecnico', 'Técnico')], default='Administrador', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='datos_usuario', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
