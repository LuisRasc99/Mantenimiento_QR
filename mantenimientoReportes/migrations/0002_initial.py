...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='maquina',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mantenimientos', to='mantenimientoReportes.maquina'),
        ),
        migrations.AddField(
            model_name='mantenimientopartes',
            name='partes',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mantenimientos', to='mantenimientoReportes.catalogopartes'),
        ),
        migrations.AddField(
            model_name='mantenimientopartes',
            name='user',
